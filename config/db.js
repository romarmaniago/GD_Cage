...
const { ensureDashRollingManualSchema } = require('../utils/ensureDashRollingManualSchema');
...
const { ensureJunketMonthlySettlementSchema } = require('../utils/ensureJunketMonthlySettlementSchema');
...
(async () => {
	try {
		...
		await ensureDashRollingManualSchema(pool);
		...
		await ensureJunketMonthlySettlementSchema(pool);
